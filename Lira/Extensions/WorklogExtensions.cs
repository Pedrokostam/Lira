...
public static class WorklogExtensions
{
    ...
    /// <param name="addedDuration"></param>
    /// <returns></returns>
    /// <param name="newComment"></param>
    public static bool GetUpdatePackage(this Worklog worklog, out WorklogUpdatePackage worklogToUpdate, DateTimeOffset? newDate = null, TimeSpan? newDuration = null, TimeSpan? addedDuration = null, string? newComment = null)
    {
        ...
        // try to add to newDuration
        if (addedDuration is not null && addedDuration != TimeSpan.Zero)
        { 
            newDuration = worklog.TimeSpent + addedDuration;
        }
